  ...
  return (
    <Document title="Solicitação de Eliminação de Dados Pessoais" author="Priva">
      <Page size="A4" style={s.page}>
        ...
        <Text style={s.p}>
          Prezados(as), na qualidade de representante autorizada do titular dos dados abaixo
          identificado, a Priva encaminha a presente solicitação de eliminação de dados pessoais,
          com fundamento na Lei nº 13.709/2018 (Lei Geral de Proteção de Dados — LGPD).
        </Text>
        ...
        <Text style={s.p}>
          Nos termos do art. 18, incisos IV e VI, da Lei nº 13.709/2018 (LGPD), o titular tem o
          direito de obter, a qualquer momento e mediante requisição, a eliminação dos dados
          pessoais tratados com o seu consentimento, bem como a anonimização, bloqueio ou eliminação
          de dados desnecessários, excessivos ou tratados em desconformidade com a referida Lei.
        </Text>
        ...
        <Text style={s.p}>
          Solicitamos a confirmação da eliminação dos dados, ou justificativa fundamentada para a
          sua manutenção, no prazo de 15 (quinze) dias a contar do recebimento desta solicitação,
          conforme a boa prática regulatória aplicável às requisições de titulares previstas na
          LGPD.
        </Text>

        <Text style={s.closing}>
          Solicitação enviada por Priva em nome do titular, conforme autorização registrada em{" "}
          {fmtDate(p.authorizedAt)}.
        </Text>
        ...
        <View style={s.footer} fixed>
          <Text style={s.footerText}>
            Documento gerado automaticamente pela Priva (www.privaapp.com.br) a pedido e mediante
            autorização do titular. Em caso de dúvidas sobre esta solicitação, contate
            contato@privaapp.com.br.
          </Text>
        </View>
      </Page>
    </Document>
