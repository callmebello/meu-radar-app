...
export function AccountCreation() {
  ...
  useEffect(() => {
    ...
    if (needAccount || needLgpd) {
      ...
      setIsPremium(true);
      // No Purchase here. PaymentReturn already fires it on the same
      // ?payment=success, with the real amount from the API and a transaction
      // id — firing again double-counted every sale, and at the wrong value
      // (29.9 while Proteção Total costs 24.9), inflating reported ROAS.
