...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Monitore vazamentos, senhas e exposição na dark web. Proteja sua identidade digital com o Meu Radar." },
      { property: "og:title", content: "Meu Radar — Proteção de Identidade Digital" },
      { name: "twitter:title", content: "Meu Radar — Proteção de Identidade Digital" },
      { property: "og:description", content: "Monitore vazamentos, senhas e exposição na dark web. Proteja sua identidade digital com o Meu Radar." },
      { name: "twitter:description", content: "Monitore vazamentos, senhas e exposição na dark web. Proteja sua identidade digital com o Meu Radar." },
